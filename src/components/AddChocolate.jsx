    ...
    return (
        <div className="">
            ...
            <div className='w-[80%] mb-10 mx-auto text-center bg-[#F6F1EE] p-10'>
                ...
                <form onSubmit={handleAddChocolate} className="w-[80%] mx-auto">
                    <div className="relative mb-4 text-left">
                        <label htmlFor="name" className="text-lg leading-7 font-semibold text-gray-600">Name</label>
                        <input placeholder="Hot Pink Chocolate" type="text" id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
                    <div className="relative mb-4 text-left flex justify-between gap-4">
                        <div className="w-full">
                            ...
                            <input placeholder="Enter Country Name" type="text" id="country" name="country" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        <div className="w-full">
                    ...
                    <div className="relative mb-4 text-left">
                        <label htmlFor="category" className="text-lg leading-7 font-semibold text-gray-600">Category</label>
                    ...
                    <input className={`bg-[#955A2C] cursor-pointer text-white my-2 text-xl text-center mx-auto rounded-md p-2 w-full font-semibold`} type="submit" value="Save" />
                </form>
            </div>
        </div>
    );
